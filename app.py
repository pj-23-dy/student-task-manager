...
from db_config import get_database_connector
...
def login():
    ...
    if request.method == 'POST':
        ...
        connection = get_database_connector()
...
def edit_student(student_id):
    ...
    query = "SELECT * from students WHERE Stud_id = %s"
...
def delete_student(student_id):
    ...
    query = "DELETE FROM students WHERE Stud_id = %s"
...
def attendance_report():
    ...
    query = """
        ...
        INNER JOIN students
            ON attendance.stud_id = students.Stud_id
...
def student_tasks():
    ...
    query = """
        ...
        INNER JOIN students
            ON student_tasks.Stud_id = students.Stud_id
...
def performance_report():
    ...
    query = """
        ...
        LEFT JOIN student_tasks
            ON students.Stud_id = student_tasks.stud_id
